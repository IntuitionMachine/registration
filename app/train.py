...
training_data = load_data('/registration/data/examples/rasa/demo-rasa.json')
#trainer = Trainer(RasaNLUConfig("/var/www/new/registration/sample_configs/config_spacy.json"),builder)
trainer = Trainer(RasaNLUConfig("/registraiton/sample_configs/config_spacy.json"),builder)

trainer.train(training_data)
#model_directory = trainer.persist('/var/www/new/registration/projects/default/')
model_directory = trainer.persist('/registration/projects/default/')
print ('dir')
print(model_directory)
#config= RasaNLUConfig("/var/www/new/registration/sample_configs/config_spacy.json")
config = RasaNLUConfig("/registration/sample_configs/config_spacy.json")
